 ...
 *
 */
public abstract class BaseTestGCPerformance {
    ...
    private final String brokerConfigPath;

    public BaseTestGCPerformance(String brokerConfigPath) {
    ...
    public void setUp() throws Exception {
        ...
        broker = BrokerFactory.createBroker( new URI( "xbean:" + brokerConfigPath ) );
